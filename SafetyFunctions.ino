...
int tapSenseMonitor()
{
  ...
  double tSense3Voltage = ((((double)tSense3*V_TEENSY)/RES)*5.99);      //Voltage cell 3. 
  double tSense2Voltage = ((((double)tSense2*V_TEENSY)/RES)*5.99);      //Voltage of cell 2.
  double tSenseTopVoltage = ((((double)tSenseTop*V_TEENSY)/RES)*5.99);  //Voltage of Top cell.
